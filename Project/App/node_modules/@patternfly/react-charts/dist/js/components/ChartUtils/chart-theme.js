...
const getCustomTheme = (themeColor, themeVariant, customTheme) => merge_1.default(exports.getTheme(themeColor, themeVariant), customTheme);
exports.getCustomTheme = getCustomTheme;
// Returns axis theme
const getAxisTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartAxisTheme);
exports.getAxisTheme = getAxisTheme;
// Returns bullet chart theme
const getBulletTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartBulletTheme);
exports.getBulletTheme = getBulletTheme;
// Returns comparative error measure theme for bullet chart
const getBulletComparativeErrorMeasureTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartBulletComparativeErrorMeasureTheme);
...
const getBulletComparativeMeasureTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartBulletComparativeMeasureTheme);
...
const getBulletComparativeWarningMeasureTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartBulletComparativeWarningMeasureTheme);
...
const getBulletGroupTitleTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartBulletGroupTitleTheme);
exports.getBulletGroupTitleTheme = getBulletGroupTitleTheme;
// Returns primary dot measure theme for bullet chart
const getBulletPrimaryDotMeasureTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartBulletPrimaryDotMeasureTheme);
...
const getBulletPrimaryNegativeMeasureTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartBulletPrimaryNegativeMeasureTheme);
...
const getBulletPrimarySegmentedMeasureTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartBulletPrimarySegmentedMeasureTheme);
...
const getBulletQualitativeRangeTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartBulletQualitativeRangeTheme);
exports.getBulletQualitativeRangeTheme = getBulletQualitativeRangeTheme;
// Returns donut theme
const getDonutTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartDonutTheme);
...
const getThresholdTheme = (themeColor, themeVariant) => exports.getCustomTheme(themeColor, themeVariant, ChartTheme_1.ChartThresholdTheme);
