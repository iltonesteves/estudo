...
exports.DonutThresholdDynamicTheme = {
    legend: {
        colorScale: [chart_donut_threshold_second_Color_1.default.value, chart_donut_threshold_third_Color_1.default.value]
    },
    pie: {
...
exports.DonutThresholdStaticTheme = {
    pie: {
        colorScale: [
            chart_donut_threshold_first_Color_1.default.value,
            chart_donut_threshold_second_Color_1.default.value,
            chart_donut_threshold_third_Color_1.default.value
        ],
