...
const getComputedLegend = ({ allowWrap = true, chartType = 'chart', dx = 0, dy = 0, height, legendComponent, padding, position = ChartTheme_1.ChartCommonStyles.legend.position, theme, width, 
// destructure last
orientation = theme.legend.orientation }) => {
    ...
    const legendPositionProps = defaults_1.default({}, legendComponent.props, {
        itemsPerRow: legendItemsPerRow
    });
    const legendX = exports.getLegendX({
        chartType,
        dx,
        height,
    ...
    const legendY = exports.getLegendY({
        chartType,
        dy,
        height,
        legendData: legendPositionProps.data,
    ...
    const legendProps = defaults_1.default({}, legendComponent.props, {
        itemsPerRow: legendItemsPerRow,
        orientation,
        standalone: false,
        theme,
...
const doesLegendFit = ({ dx = 0, height, legendPosition, legendData, legendOrientation, legendProps, padding, theme, width }) => {
    ...
    const legendDimensions = exports.getLegendDimensions({
        legendData,
        legendOrientation,
        legendProps,
        theme
...
const getLegendItemsPerRow = ({ dx, height, legendPosition, legendData, legendOrientation, legendProps, padding, theme, width }) => {
    ...
    for (let i = itemsPerRow; i > 0; i--) {
        const fits = exports.doesLegendFit({
            dx,
            height,
            legendPosition,
            legendData,
