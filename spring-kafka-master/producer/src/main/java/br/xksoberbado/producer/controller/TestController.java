...
//        jsonKafkaTemplate.send("person-topic", new Person("João", new Random().nextInt(50)));
	...
	public void sendCity() {
		...
		kafkaTemplate1.send("city-topic", new City("Porto Alegre", "RS")).addCallback(success -> {
			City city = (City)success.getProducerRecord().value();
			System.out.println("city....    " + city.getName());
			System.out.println(success.getProducerRecord().value());
		}, Failure -> System.out.println("erro"));
	}
